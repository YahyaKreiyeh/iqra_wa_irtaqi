...
@override
String toString() {
  return 'CenterState(id: $id, isEditing: $isEditing, initialName: $initialName, initialLocation: $initialLocation, initialNotes: $initialNotes, name: $name, nameErrorKey: $nameErrorKey, location: $location, locationErrorKey: $locationErrorKey, notes: $notes, status: $status)';
}
...
class _CenterState implements CenterState {
   _CenterState({this.id = '', this.isEditing = false, this.initialName = '', this.initialLocation = '', this.initialNotes = '', this.name = '', this.nameErrorKey, this.location = '', this.locationErrorKey, this.notes = '', this.status = const Result.empty()});
